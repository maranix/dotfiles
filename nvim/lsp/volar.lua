...
local function get_typescript_server_path(root_dir)
    local dir = vim.fs.dirname(vim.fs.find('node_modules', { path = root_dir or vim.uv.cwd(), upward = true })[1])
...
local volar_init_options = {
    typescript = {
        -- Pass your global typescript sdk path to this function, by default it'll fall back to local one if not defined
